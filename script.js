...
function getdiameter(radius) {
  ...
  console.log(
    `the diameter of circle is ${diameter} , circumference is ${circumference} & The Area of circle is ${Area}`
  );
  }
  getdiameter(3);
...
function FindMaxMin(num1, num2) {
  if (num1 > num2) {
    ...
    console.log(` ${num2}  ==  ${num1} Both numbers are equal`);
  } else {
